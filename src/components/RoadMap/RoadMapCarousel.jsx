...
const RoadMapCarousel = ({ url }) => {
  return (
    <div className="xxl:inline hidden">
      <div className="w-80  md:w-fit border bg-white/30 md:flex lg:h-96 lg:w-[65%]">
        <div className="border md:text-center items-center flex md:w-[80px] justify-center">
          <p className="text-yelloww text-2xl md:-rotate-90 md:flex md:gap-4">
            <span>PHASE </span>
            <span> 01</span>
          </p>
        </div>
        ...
        <div className="p-8 flex flex-col justify-center lg:pr-[10%] pr-[5%] md:p-2 md:w-2/3">
          ...
          <p className="text-white mt-2">
            ...
            ad minim veniam wekdhwelkcje iwejfdlpwemc qkeudoqef
          </p>
          <button
            className="btn2 flex justify-center items-center px-5 py-2 md:mr-[60%] relative border text-white bg-blue-800 border-white uppercase font-semibold tracking-wider leading-none overflow-hidden hover:text-black mt-4"
            type="button"
          >
